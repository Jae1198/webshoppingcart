...
products[0] = new Product("war_eternal", "War Eternal by Arch Enemy",  1.50);
products[1] = new Product("we_will_rise", "We Will Rise by Arch Enemy",  1.50);
products[2] = new Product("avalanche", "Avalanche by Arch Enemy",  1.50);
products[3] = new Product("the_sound_of_silence", "The Sound of Silence by Disturbed",  1.50);
products[4] = new Product("innocence", "Innocence by Disturbed",  1.50);
products[5] = new Product("incipit_satan", "Incipit Satan by Gorgoroth",  1.50);
products[6] = new Product("krig", "Krig by Gorgoroth",  1.50);
products[7] = new Product("the_negative_one", "The Negative One by Slipknot",  1.50);
products[8] = new Product("ghosts", "Ghosts by Pvris",  1.50);
products[9] = new Product("fire", "Fire by Pvris",  1.50);
products[10] = new Product("mirrors", "Mirrors by Pvris",  1.50);
products[11] = new Product("never_lose_your_flames", "Never Lose Your Flames by Issues",  1.50);
products[12] = new Product("coma", "COMA by Issues",  1.50);
products[13] = new Product("mia", "M.I.A. by Avenged Sevenfold",  1.50);
products[14] = new Product("scream", "Scream by Avenged Sevenfold",  1.50);
products[15] = new Product("always", "Always by Killswitch Engage",  1.50);
products[16] = new Product("hero", "Hero by Skillet",  1.50);
products[17] = new Product("monster", "Monster by Skillet",  1.50);
products[18] = new Product("whispers_in_the_dark", "Whispers In The Dark by Skillet",  1.50);
products[19] = new Product("animal_i_have_become", "Animal I Have Become by Three Days Grace",  1.50);
products[20] = new Product("i_am_machine", "I Am Machine by Three Days Grace",  1.50);
products[21] = new Product("human", "Human by Manafest",  1.50);
products[22] = new Product("no_plan_b", "No Plan B by Manafest",  1.50);
products[23] = new Product("all_around_me", "All Around Me by Flyleaf",  1.50);
